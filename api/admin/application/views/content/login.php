                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="text-center sm-5 mb-4 text-black-50">
                                <div>
                                <a href="<?php  echo base_url().'';?>" class="d-inline-block auth-logo">
                                    <img src="codebright.png" alt="" height="80">
                                </a>
                            </div>
                                
                            <p class="mt-4 fs-15 fw-medium">Welcome to Code Bright</p>
                            </div>
                                <div class="p-2 mt-4">
...
<!--                                            <div class="float-end">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input" required placeholder="Enter password" name="password" id="password-input">
                                        ...
                                        <div class="mt-4">
                                            <button id="publish-button" type="submit" class="btn btn-secondary w-100" type="submit">Sign In</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
