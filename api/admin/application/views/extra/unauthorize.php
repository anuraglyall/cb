                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center pt-4">
                            ...
                            <div class="mt-n4">
                                <h1 class="display-1 fw-medium">401 UNAUTHORIZED</h1>
                                <h3 class="text-uppercase">Sorry, Not Authorized 😭</h3>
                                <p class="text-muted mb-4">You are not authorize to access this page!</p>
                                <a href="dashboard" class="btn btn-secondary"><i class="mdi mdi-home me-1"></i>Back to home</a>
                            </div>
                        </div>
                    </div>
                </div>
