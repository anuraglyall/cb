...
//                                                echo '</pre>';
                                                ...
                                                <div class="mb-3 col-md-12 pull-left" style="<?php if($perameters_res[1]=='hidden') { echo 'display:none;'; } ?>float:left;padding:0px 5px;">
                                                    ...
                                                    <input value="<?php //echo $perameters_res[4];  ?>" type="<?php echo $perameters_res[1];  ?>" id="<?php echo $perameters_res[0];  ?>" name="<?php echo $perameters_res[0];  ?>" class="form-control" <?php echo $perameters_res[3];  ?> />
                                                </div>
                                                <?php 
                                                }
